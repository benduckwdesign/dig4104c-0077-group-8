...
if "%PHPBIN%" == "" set PHPBIN=C:\Users\miniluigi\ucfgithubproject\dig4104c-0077-group-8\develop-phase\xampp\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "C:\Users\miniluigi\ucfgithubproject\dig4104c-0077-group-8\develop-phase\xampp\php\phpunit" %*
