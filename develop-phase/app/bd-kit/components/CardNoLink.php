...
class CardNoLink extends BDComponent {
    ...
    function __construct() {
        ...
        if (count($arg_children) == 0) {
            $this->children = ["<div style=\"display:block;flex-grow:1;width:400px;height:70px;color:".$TEXT_COLOR.";background-color:".$CARD_BG_COLOR.";border-radius:10px;margin:10px;\">",
                                "<div style=\"width:auto;\">",
                                    "<h6 style=\"padding:5px;line-height:1;\"><b>".$title_string."</b></h6>",
                                "</div>",
                                "<div style=\"height:24px;width:auto;background-color:".$TRANSPARENT_BG_COLOR.";\">",
                                "</div>",
                           "</div>"];
            return;
        } else {
