...
class FrameFlexRow extends BDComponent {
    ...
    function __construct() {
        ...
        $this->children = ["<div style=\"display:flex;flex-direction:row;color:".$TEXT_COLOR.";flex-wrap:nowrap;height:calc(100vh - 100px);\">", "</div>"];
