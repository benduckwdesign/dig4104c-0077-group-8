...
class NavSidebarWrapper extends BDComponent {
    ...
    function __construct() {
        ...
        $this->children = ["<div style=\"float:left;position:absolute;top:0;width:209px;min-height:100vh;align-items:center;color:".$TEXT_COLOR.";background-color:".$TRANSPARENT_BG_COLOR.";\">", "</div>"];
